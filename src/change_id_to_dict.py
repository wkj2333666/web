...
def change_singer_to_dict(row: pd.Series) -> pd.Series:
    try:
        ...
        for singer_name in row.singers:
            ...
            new_singer_dict['singer_id'] = df_singer.loc[df_singer['singer_name'] == singer_name].iloc[0].singer_id
...
def change_song_to_dict(row_singer: pd.Series) -> pd.Series:
    ...
    for song_id in row_singer.songs_id:
        try:
            ...
            new_song_dict['song_name'] = df_song.loc[df_song['song_id'] == song_id].iloc[0].song_name
